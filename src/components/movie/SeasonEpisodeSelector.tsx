...
function EpisodeCard({ episode, tvId }: { episode: Episode; tvId: number }) {
    ...
    <div className="flex gap-4 bg-white/5 hover:bg-white/10 transition-colors rounded-xl p-3 border border-white/10">
      ...
      <div className="flex flex-col justify-between flex-1 gap-1">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <button className="flex items-center gap-2 bg-red-600 hover:bg-red-700 active:scale-95 transition-all text-white text-xs font-bold px-4 py-2 rounded-lg">
            ▶ Play
          </button>
        </div>
      </div>
