    ...
    <div className="relative w-full min-h-[70vh] flex items-end">
      ...
      <div className="relative z-10 w-full pb-10 flex flex-col md:flex-row gap-8 items-end md:items-start">
        ...
        <div className="flex flex-col gap-3 flex-1">
          ...
          {/* TMDB ID (hidden, useful for debugging) */}
          <p className="text-gray-600 text-xs">TMDB ID: {item.id}</p>

          {/* Watch Now Button */}
          <button className="mt-2 w-fit flex items-center gap-2 bg-red-600 hover:bg-red-700 active:scale-95 transition-all text-white font-bold px-8 py-3 rounded-xl text-base shadow-lg shadow-red-900/40">
            ▶ Watch Now
          </button>
        </div>
      </div>
